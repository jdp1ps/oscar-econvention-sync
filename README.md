...
```
**Note:** If you only need to run the application (preprod or production), use requirements-preprod.txt instead of the dev file.
...
It should display something like:```dags -> /home/user/oscar-econvention-sync/dags```
